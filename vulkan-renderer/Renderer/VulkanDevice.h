...
private:
	...
	bool									check_physical_device_extensions(const std::vector<const char *> & desired_extensions);
	bool									get_device_extensions_properties(std::vector<VkExtensionProperties>& device_extensions);
